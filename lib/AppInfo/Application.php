...
namespace OCA\FilesRightClick\AppInfo;

use OCA\Files_Sharing\Event\BeforeTemplateRenderedEvent as SharingBeforeTemplateRenderedEvent;
use OCA\FilesRightClick\Listener\BeforeLoggedInTemplateRenderedListener;
use OCA\FilesRightClick\Listener\BeforeTemplateRenderedListener;
...
class Application extends App implements IBootstrap {
	...
	public function __construct() {
		parent::__construct('files_rightclick');
	}
